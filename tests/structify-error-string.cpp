...
TEST_CASE("test_make_error_string", "[structify][error]")
{
...
TEST_CASE("test_make_error_string_unnasigned_required_member", "[structify][error]")
{
...
TEST_CASE("test_make_error_string_missing_member", "[structify][error]")
{
  static const char json_data[] = R"json({
  "One": "foo / bar",
  "Two": "foo \/ bar",
  ...
  auto error = context.parseTo(substruct);
  (void) error;
  context.error = STFY::Error::MissingPropertyMember;
...
TEST_CASE("test_make_error_string_missing_members", "[structify][error]")
{
  static const char json_data[] = R"json({
  "One": "foo / bar",
  "Two": "foo \/ bar",
