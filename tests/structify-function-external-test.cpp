...
STFY_FUNCTION_CONTAINER_EXTERNAL(CallFunction, STFY_FUNCTION(execute_one), STFY_FUNCTION(execute_two),
                               STFY_FUNCTION(execute_three))
...
STFY_FUNCTION_CONTAINER_EXTERNAL(CallFunctionSuperSuper, STFY_FUNCTION(execute_one))
...
STFY_FUNCTION_CONTAINER_EXTERNAL(CallFunctionSuper, STFY_FUNCTION(execute_two))
...
STFY_FUNCTION_CONTAINER_EXTERNAL_WITH_SUPER(CallFunctionSub,
                                          STFY_SUPER_CLASSES(STFY_SUPER_CLASS(CallFunctionSuperSuper),
                                                           STFY_SUPER_CLASS(CallFunctionSuper)),
                                          STFY_FUNCTION(execute_three))
namespace
{
...
STFY_FUNCTION_CONTAINER_EXTERNAL_WITH_SUPER_WITHOUT_MEMBERS(CallFunctionVirtualOverload, STFY_SUPER_CLASSES(STFY_SUPER_CLASS(CallFunction)))
...
STFY_FUNCTION_CONTAINER_EXTERNAL(SuperParamCallable, STFY_FUNCTION(execute_one))
...
STFY_FUNCTION_CONTAINER_EXTERNAL(CallVoidStruct, STFY_FUNCTION(call_void), STFY_FUNCTION(call_void_context),
                               STFY_FUNCTION(call_int_void), STFY_FUNCTION(call_int_void_context),
                               STFY_FUNCTION(call_void_with_value), STFY_FUNCTION(call_void_error))
...
STFY_FUNCTION_CONTAINER_EXTERNAL(CallErrorCheck, STFY_FUNCTION(call_void), STFY_FUNCTION(call_with_int),
                               STFY_FUNCTION(call_another_void), STFY_FUNCTION(call_with_object))
...
STFY_FUNCTION_CONTAINER_EXTERNAL(JsonWrongArgType, STFY_FUNCTION(execute_one), STFY_FUNCTION(execute_two),
                               STFY_FUNCTION(execute_three))
