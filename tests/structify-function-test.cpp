...
struct CallFunction
{
  ...
  STFY_FUNCTION_CONTAINER(STFY_FUNCTION(execute_one), STFY_FUNCTION(execute_two), STFY_FUNCTION(execute_three));
...
struct CallFunctionSuperSuper
{
  ...
  STFY_FUNCTION_CONTAINER(STFY_FUNCTION(execute_one));
};
...
struct CallFunctionSuper
{
  ...
  bool called_two = false;
  STFY_FUNCTION_CONTAINER(STFY_FUNCTION(execute_two));
};
...
struct CallFunctionSub : public CallFunctionSuperSuper, public CallFunctionSuper
{
  ...
  bool called_three = false;
  STFY_FUNCTION_CONTAINER_WITH_SUPER(STFY_SUPER_CLASSES(STFY_SUPER_CLASS(CallFunctionSuperSuper),
...
struct CallVoidStruct
{
  ...
  STFY_FUNCTION_CONTAINER(STFY_FUNCTION(call_void), STFY_FUNCTION(call_void_context), STFY_FUNCTION(call_int_void),
                        STFY_FUNCTION(call_int_void_context), STFY_FUNCTION(call_void_with_value),
                        STFY_FUNCTION(call_void_error));
};
...
struct CallErrorCheck
{
  ...
  STFY_FUNCTION_CONTAINER(STFY_FUNCTION(call_void), STFY_FUNCTION(call_with_int), STFY_FUNCTION(call_another_void),
                        STFY_FUNCTION(call_with_object));
...
struct JsonAlias
{
  ...
  STFY_FUNCTION_CONTAINER(STFY_FUNCTION(execute_one), STFY_FUNCTION_ALIASES(execute_two_primary, "execute_two"),
                        STFY_FUNCTION(execute_three));
};
