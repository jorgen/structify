...
static bool TryParse(const std::string& json)
{
  ...
  T container;
  STFY::Error parseError = context.parseTo(container);

  bool parsedSuccessfully = parseError == STFY::Error::NoError;
...
TEST_CASE("nested_optional", "structify")
{
