...
struct CallFunction
{
  ...
  STFY_FUNC_OBJ(execute_one, execute_two, execute_three);
...
struct CallFunctionSub : public CallFunctionSuperSuper, public CallFunctionSuper
{
  ...
  bool called_three = false;
  STFY_FUNC_OBJ_SUPER(STFY_SUPER(CallFunctionSuperSuper, CallFunctionSuper), execute_three);
};
...
struct CallVoidStruct
{
  ...
  STFY_FUNC_OBJ(call_void, call_void_context, call_int_void, call_int_void_context, call_void_with_value,
              call_void_error);
};
...
struct CallErrorCheck
{
  ...
  STFY_FUNC_OBJ(call_void, call_with_int, call_another_void, call_with_object);
