...
namespace structify_short_notation
{
...
struct SubStruct
{
  ...
  STFY_OBJ(SubString, SubNumber, Array, optional_float, optional_with_value);
};
...
struct SubStruct3 : public SubStruct2
{
  ...
  STFY_OBJ_SUPER(STFY_SUPER(SubStruct2), Field3, Field4, Field5);
};
...
struct JsonData1
{
  ...
  STFY_OBJ(StringNode, NumberNode, BooleanTrue, BooleanFalse, OptionalInt, TestStruct, OptionalButWithData,
         unassigned_value, subStruct2, Field3, NodeWithLiteral);
};

TEST_CASE("short_check_json_tree_nodes", "structify")
{
...
struct SubObject
{
  ...
  STFY_OBJ(more_data, a_float, boolean_member);
};

TEST_CASE("short_check_json_tree_template", "structify")
{
...
TEST_CASE("short_check_json_tree_subclass", "structify")
{
...
{
  std::string Super;
  STFY_OBJ_SUPER(STFY_SUPER(SuperSuperClass), Super);
};

struct RegularClass : public SuperClass
{
  int Regular;
  STFY_OBJ_SUPER(STFY_SUPER(SuperClass), Regular);
};

TEST_CASE("short_check_json_tree_deep_tree", "structify")
{
...
struct MissingObjectDef
{
  ...
  STFY_OBJ(first, second, fourth);
};

TEST_CASE("short_check_json_missing_object", "structify")
{
...
struct ErrorInSub
{
  ...
  STFY_OBJ(first, second, third);
};

TEST_CASE("short_check_json_error_in_sub", "structify")
{
...
TEST_CASE("short_check_json_object", "structify")
{
...
TEST_CASE("short_check_json_object_or_array_object", "structify")
{
  STFY::ParseContext context(jsonObjectTest);
...
TEST_CASE("short_check_json_object_ref", "structify")
{
  STFY::ParseContext context(jsonObjectTest);
...
TEST_CASE("short_check_json_object_or_array_object_ref", "structify")
{
  STFY::ParseContext context(jsonObjectTest);
...
TEST_CASE("short_check_json_array", "structify")
{
...
TEST_CASE("short_check_json_object_or_array_array", "structify")
{
  STFY::ParseContext context(jsonArrayTest);
...
TEST_CASE("short_check_json_array_ref", "structify")
{
  STFY::ParseContext context(jsonArrayTest);
...
TEST_CASE("short_check_json_object_or_array_array_ref", "structify")
{
  STFY::ParseContext context(jsonArrayTest);
...
TEST_CASE("short_check_json_map", "structify")
{
...
struct TypeHandlerTypes
{
  ...
  STFY_OBJ(doubleN, floatN, intN, uintN, int64N, uint64N, int16N, uint16N, uint8N, int8N, charN, scharN, ucharN, boolN);
};
...
TEST_CASE("short_check_json_type_handler_types", "structify")
{
...
struct TypeHandlerIntTypes
{
  ...
  STFY_OBJ(intN, uintN, int64N, uint64N, int16N, uint16N, uint8N, int8N, charN, scharN, ucharN, boolN);
};
...
TEST_CASE("short_check_json_type_handler_integer_types", "structify")
{
...
TEST_CASE("short_check_json_array_test", "structify")
{
...
struct SkipTestSubClass : public SkipTestBase
{
  ...
  STFY_OBJ_SUPER(STFY_SUPER(SkipTestBase), value, skip_test_list_01, skip_test_list_02);
};
...
TEST_CASE("short_check_json_skip_test", "structify")
{
...
TEST_CASE("short_check_multi_top_level_json", "structify")
{
...
TEST_CASE("short_check_json_escaped", "structify")
{
...
STFY_OBJ_EXT(structify_short_notation::OutsideMeta, data, a)
...
TEST_CASE("short_check_json_meta_outside", "structify")
{
...
TEST_CASE("short_check_short_floating_point", "structify")
{
...
TEST_CASE("short_check_invalid_floating_point", "structify")
{
...
struct MoreEscapedStruct
{
  ...
  STFY_OBJ(some_text, some_other, pure_escape, strange_escape, pure_strange_escape, empty_string);
};

TEST_CASE("short_check_json_escaped_end", "structify")
{
